...
public class QuranFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        databaseReference= firebaseDatabase.getReference("Quran_Best_Student");
            ...
            public void onClick(View view) {
                ...
                if (imgArrayList.size() != 0) {
                   ...
                   String third=imgArrayList.get(2);
                    ...
                    databaseReference=firebaseDatabase.getReference("Quran");
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode==1 && resultCode==RESULT_OK){
            ...
            storageReference = firebaseStorage.getReference("Images_quran/"+rand);
