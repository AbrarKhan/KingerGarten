package app.kingergarten.kingergarten.admin.navigation_admin;
...
import app.kingergarten.kingergarten.admin.add_users.AddUsersFragment;
...
import app.kingergarten.kingergarten.admin.home_admin.HomeAdminFragment;
...
public class Navigation_admin extends KindergartenBaseActivity
        ...
        HomeAdminFragment.OnFragmentInteractionListener,
        AddUsersFragment.OnFragmentInteractionListener
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        HomeAdminFragment homeFragment= HomeAdminFragment.newInstance(null,null);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            fragment= HomeAdminFragment.newInstance("HOME",null);
            ...
            fragment= AddUsersFragment.newInstance("TIME TABLE",null);
        } else if (id == R.id.nav_reg_std) {
            ...
            Intent intent=new Intent(Navigation_admin.this,Navigation.class);
            startActivity(intent);
